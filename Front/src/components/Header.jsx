...
//   }
  ...
  return (
    <>
      <nav className="bg-gray-100  dark:bg-gray-500 text-gray-900 dark:text-white-ghost px-2 sm:px-4 p-0 sticky w-full z-10 top-0 py-1 left-0">
        <div className="container flex justify-between md:justify-end h-16 items-center mx-auto px-2">
          <a href="https://flowbite.com/" className="flex items-center md:invisible ">
            <img src="./src/assets/Lavorar-logo-negativo.svg" className="mr-6 w-16" alt="Logo" />
          ...
          <div className="flex md:order-2 ">
            ...
            <>
              ...
              <div className={`${false ? "hidden md:block " : "hidden "}  h-52 mt-3 -ml-24  md:absolute md:w-60  justify-between items-center w-full `} id="notificationBar">
        ...
        <div className=' sm:hidden md:hidden justify-between items-center w-full md:w-auto md:order-1 id="navbar-sticky"'>
        ...
        <div className={`${false ? "block " : "hidden "}  md:hidden justify-between items-center w-full `} id="notificationBar">
